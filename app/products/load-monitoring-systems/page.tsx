...
export const metadata: Metadata = {
  title: "Load Monitoring Systems | Pascal Auto Solutions",
  description: "Pressing Process Load monitoring for various components such as Bearing, Bush, Dowel, etc.",
};

export default function LoadMonitoringSystemsPage() {
  const features = [
    "Load Vs Displacement, x-y plot graph will be shown on HMI.",
    "User settable parameters for load monitoring.",
    "Alarm messages in case of Over-load or Under-load conditions.",
    "Data logging - using USB Pen-drive."
  ];
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
      ...
      <div className="relative h-80 md:h-[32rem] w-full bg-white overflow-hidden p-2 md:p-4 border-b border-slate-100">
        <img 
          src="/products/Load-Monitoring-Systems.image.png" 
          alt="Load Monitoring System" 
      ...
      <div className="p-8 md:p-12">
        <div className="mb-12">
          <p className="text-lg md:text-xl text-slate-700 leading-relaxed font-medium">
            Pressing Process <span className="font-bold text-slate-900">Load monitoring</span> for various components such as <span className="font-black text-[#0047b3] tracking-tight">Bearing, Bush, Dowel, etc.</span>
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-slate-900 to-[#002f7a] rounded-2xl p-8 md:p-10 text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl shadow-blue-900/10">
          <div>
            <h4 className="text-2xl font-black tracking-tight mb-2">Ensure perfect assembly quality?</h4>
            <p className="text-slate-300 text-sm md:text-base">Contact our engineering team to discuss load monitoring integration for your pressing processes.</p>
          </div>
          <a 
            href="/contact" 
