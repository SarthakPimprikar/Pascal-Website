...
export const metadata: Metadata = {
  title: "VIN Number Marking Machines | Pascal Auto Solutions",
  description: "VIN number marking machines with repeat number check functionality for various auto components.",
};

export default function VinNumberMarkingMachinesPage() {
  const features = [
    "Application specific design ensures marking at exact position.",
    "Auto barcode scanning.",
    "Repeat number check up to 30,000 VIN Numbers.",
    "Option of percussion and scribing."
  ];
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
      ...
      <div className="relative h-80 md:h-[32rem] w-full bg-white overflow-hidden p-2 md:p-4 border-b border-slate-100">
        <img 
          src="/products/VIN-Number-Marking-Machines.image.png" 
          alt="VIN Number Marking Machine" 
      ...
      <div className="p-8 md:p-12">
        <div className="mb-12">
          <p className="text-lg md:text-xl text-slate-700 leading-relaxed font-medium">
            <span className="font-bold text-slate-900">VIN number marking machines</span> with <span className="font-black text-[#0047b3] tracking-tight">repeat number check functionality</span> for various auto components such as Engine crankcase, Chassis, 3w Dash-board, Steering Column, etc. having data B Pillar.
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-slate-900 to-[#002f7a] rounded-2xl p-8 md:p-10 text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl shadow-blue-900/10">
          <div>
            <h4 className="text-2xl font-black tracking-tight mb-2">Need robust traceability?</h4>
            <p className="text-slate-300 text-sm md:text-base">Contact our engineering team to discuss barcode scanning and marking solutions for your components.</p>
          </div>
          <a 
            href="/contact" 
